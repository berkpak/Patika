...
public class BookingView extends Layout{
    ...
    public BookingView(Car selectedCar, String strt_date, String fnsh_date){
        ...
        lbl_car_info.setText("Arac : " +
                this.car.getPlate() + " / " +
                this.car.getModel().getBrand_id() + " / " + //brand_id yi get getBrand().getName() ile degistir.
        ...
        //test
        this.fld_book_name.setText("Berk");
        this.fld_book_idno.setText("1234");
        this.fld_book_mail.setText("test@gmail.com");
        this.fld_book_mpno.setText("1234");
        this.fld_book_prc.setText("1234");
        this.txta_book_note.setText("not test");
