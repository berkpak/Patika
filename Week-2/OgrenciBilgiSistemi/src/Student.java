public class Student {
    ...
    public void calcAvarage() {
        ...
        double toplamFizik =  (this.fizik.verbalNote * 0.20) + (this.fizik.note * 0.80);
        double toplamKimya =  (this.kimya.verbalNote * 0.20) + (this.kimya.note * 0.80);
        double toplamMat =    (this.mat.verbalNote * 0.20) + (this.mat.note * 0.80);

        this.avarage = toplamFizik + toplamKimya + toplamMat / 3;
    }
